...
class subst_cipher:
    ...
    def find_chains(self):
        chains = [self.chain_from_letter(cl) for cl in self.clear2cipher]
...
def main():
    ...
    print(C.encipher(ascii_uppercase))
    print(C.decipher(ascii_uppercase))
    print(" ")
